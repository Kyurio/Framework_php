...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
  <div class="sidebar-sticky pt-3">
    <ul class="nav flex-column" id="myTab" role="tablist">
      ...
      <li class="nav-item" role="presentation">
        <a class="nav-link" @click="changeTitle('Configuracion de el sistema')" id="configuracion-tab" data-bs-toggle="tab" href="#configuracion" role="tab" aria-controls="configuracion" aria-selected="true"> <i class="fas fa-hand-holding-usd"></i> Mis Gastos</a>
      </li>

      <li class="nav-item" role="presentation">
        <a class="nav-link" @click="changeTitle('Configuracion de el sistema')" id="configuracion-tab" data-bs-toggle="tab" href="#configuracion" role="tab" aria-controls="configuracion" aria-selected="true"> <i class="fas fa-dollar-sign"></i> Gastos Sucursal</a>
      </li>
